...
options.register('inputFiles',
                 "file:/uscms/home/dryu/HCAL/data/HCALPFG/PulseShape/824DE93E-C717-E611-BEC8-02163E0137C1.root", #default value, corresponds to LFN /store/data/Commissioning2016/MinimumBias/RAW/v1/000/264/232/00000/1EDB8470-71D1-E511-A299-02163E014504.root from run 267594
                 VarParsing.VarParsing.multiplicity.list,
                 VarParsing.VarParsing.varType.string,
                 "Input files")

options.register('outputFile',
                 "file:/uscms/home/dryu/HCAL/data/HCALPFG/PulseShape/hcalTupleTree_test.root", #default value
                 VarParsing.VarParsing.multiplicity.singleton,
                 VarParsing.VarParsing.varType.string,
                 "Output file")
...
process.bunchNumberFilter.selectedBXs = cms.untracked.vuint32(1)
