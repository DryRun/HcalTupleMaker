...
options.register('inputFiles',
                 "root://cmsxrootd-site.fnal.gov//store/data/Run2016B/JetHT/RAW/v2/000/273/150/00000/824DE93E-C717-E611-BEC8-02163E0137C1.root", #default value, corresponds to LFN /store/data/Commissioning2016/MinimumBias/RAW/v1/000/264/232/00000/1EDB8470-71D1-E511-A299-02163E014504.root from run 267594
                 VarParsing.VarParsing.multiplicity.list,
                 VarParsing.VarParsing.varType.string,
                 "Input files")

options.register('outputFile',
                 "file:/uscms/home/dryu/HCAL/data/HCALPFG/PulseChape/hcalTupleTree_test.root", #default value
                 VarParsing.VarParsing.multiplicity.singleton,
                 VarParsing.VarParsing.varType.string,
                 "Output file")
