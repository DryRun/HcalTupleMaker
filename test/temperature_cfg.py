...
options.register('inputFiles',
                 "root://eoscms.cern.ch//eos/cms/store/data/Run2018A/ZeroBias/RAW/v1/000/315/689/00000/A41CDFAE-094F-E811-BE35-FA163EF9243C.root",
                 VarParsing.VarParsing.multiplicity.list,
                 VarParsing.VarParsing.varType.string,
                 "Input files")

options.register('outputFile',
                 "temperature_testtree.root", # default value
                 VarParsing.VarParsing.multiplicity.singleton,
                 VarParsing.VarParsing.varType.string,
                 "Output file")
...
process.hcalTupleHBHEDigis.DoEnergyReco = True
