...
storagepath = '/store/user/dryu/HCALPFG/temperature/' # DO NOT USE

# cmsRun file
psetname = 'temperature_cfg.py'
...
config.General.workArea        = "crabdir_temperature"
...
config.Data.runRange         = '315689-315690' # 316569
...
config.Data.lumiMask        = '/afs/cern.ch/user/d/dryu/workspace/private/DQM/pedestals/CMSSW_10_2_0_pre4/src/HCALPFG/HcalTupleMaker/test/temperature_json.txt'
